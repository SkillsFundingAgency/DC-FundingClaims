...
BEGIN
	...
	USING (
			...
			UNION SELECT 174 AS [CollectionId],N'1920-Final'   AS [CollectionName],1920 as CollectionYear, N'Final (R14) Funding Claim 2019 to 2020'  as DisplayTitle,N'2020-10-26T08:00:00.000' AS [SubmissionOpenDateUtc],N'2020-11-03T17:00:00.000' AS [SubmissionCloseDateUtc],N'2020-11-04T17:00:00.000' [SignatureCloseDateUtc],1 AS [RequiresSignature],N'FC03' AS [CollectionCode],201908 AS [SummarisedPeriodFrom],202007 AS [SummarisedPeriodTo], N'R14' AS [SummarisedReturnPeriod], N'2020-10-22T17:00:00.000' AS [HelpdeskOpenDateUtc], GetUtcDate() AS [DateTimeUpdatedUtc], 'System' As [UpdatedBy]
